...
Route::get('/pustakawan/pemusnahan/{id}/berita-acara/pdf', [DashboardController::class, 'exportPdfBeritaAcaraPemusnahan'])->name('pustakawan.pemusnahan.berita_acara_pdf');
