...
<head>
    ...
    <title>Laporan Kategori Terpopuler</title>
    ...
    <div class="container mt-5">
        <div class="card shadow border-0">
            <div class="card-header text-white d-flex justify-content-between align-items-center py-3">
                <h5 class="mb-0 fw-bold"><i class="fas fa-tags me-2"></i> Laporan Kategori Buku Paling Sering Dipinjam</h5>
                <a href="{{ url('/laporan/kategori-populer/pdf') }}" class="btn btn-danger btn-sm shadow-sm">
                    ...
                    <table class="table table-hover align-middle text-center">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th width="40%">Frekuensi Dipinjam</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-capitalize text-dark fw-semibold text-start ps-5">{{ $data->deskripsi }}</td>
                                <td>
            ...
            <div class="card-footer bg-white text-muted small py-3">
                <i class="fas fa-calendar-check me-1"></i> Data Tahun {{ $tahun }}
            </div>
        </div>
    </div>
</body>
