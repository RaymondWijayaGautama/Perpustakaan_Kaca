...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('mst_siswa', function (Blueprint $table) {
            // Agar data siswa bisa otomatis bertambah ID-nya tanpa error saat seeder berjalan,
            // saya tambahkan parameter "true" agar menjadi Auto-Increment.
            ...
            // --- TAMBAHAN KOLOM BARU DARI SEEDER KAMU ---
